...
export function GuideArticleHero({ eyebrow, heading, subtitle }: GuideArticleHeroProps) {
  return (
    <section className="relative overflow-hidden border-b border-line">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1200px] px-5 py-14 text-center sm:px-6 sm:py-20 lg:px-8">
        <div className="reveal flex flex-col items-center">
          ...
          <p className="mt-3 max-w-2xl text-[clamp(0.9rem,1.6vw,1.05rem)] leading-relaxed text-fg-muted">{subtitle}</p>
        </div>
      </div>
    </section>
  );
